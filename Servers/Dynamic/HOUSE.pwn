...
1. Masukkan houses.sql ke database
2. Masukkan mysql_tquery(g_SQL, "SELECT * FROM `houses`", "LoadHouses"); ke GM

CMD nya : /createhouse, /edithouse, /typehouses, /lockhouse, /givehouse, /sellhouse, /myhouse, /hm
*/
//House System
